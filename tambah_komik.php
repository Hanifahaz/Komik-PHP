  ...
  <form action="aksi.php" method=POST>
    <table>
        ...
        <tr>
            ...
            <td><input type="text" name="id_komik"></td></br>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="genre_komik"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><textarea name="sinopsis" rows="5" cols="30"></textarea></td>
        </tr>
        <tr>
            <td></td>
            <td><input type="submit" value="Simpan" name="proses"><input type="reset"></td>
        </tr>
