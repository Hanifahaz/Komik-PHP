...
<div class="w3-main" style="margin-left:250px">
  ...
  include "koneksi.php";
    ...
    echo "<table border=1 >";
    echo "<tr><th>No</th><th>Email</th><th width=150px>Username</th><th>Hapus</th></tr>";
    ...
    while($kolom = mysqli_fetch_array($query)){
        ...
        $hapus = "<a href=?email=$email>Hapus</a>";
        echo "<tr><td align=center>$noo</td><td>$email</td><td>$username</td><td>$hapus</td></tr>";
        $noo++;
    }
