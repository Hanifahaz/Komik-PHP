...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top w3-animate-left" style="z-index:3;width:250px" id="mySidebar">
  <div class="w3-container w3-display-container w3-padding-16">
    ...
    <!----<img src="foto5.jpg" style="width:45%;" class="w3-round"><br><br>---->
...
<div class="w3-main" style="margin-left:250px">
  ...
  <!-- Header -->
  <header>
  <!----<a href="profile.php"><img src="foto5.jpg" style="width:65px;" class="w3-circle w3-right w3-margin w3-hide-large w3-hover-opacity"></a>--->
